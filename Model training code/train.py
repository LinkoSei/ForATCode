...
parser.add_argument('--config',default=r"D:\ATC\Model training code\content\config\daic-c2-rmse-roc.yaml", help='Path to the configuration file')
...
with open(config_file, 'r', encoding=result['encoding']) as f:
